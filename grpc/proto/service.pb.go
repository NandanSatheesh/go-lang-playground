...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0x5c, 0x9a, 0x53, 0x02, 0x55, 0x0c, 0xe5, 0x19, 0x99, 0x70, 0x71, 0x39, 0xa6, 0xa4, 0x04, 0x43,
	0x6c, 0x11, 0x52, 0xe3, 0x62, 0x76, 0x4c, 0x49, 0x11, 0xe2, 0x83, 0x58, 0xa7, 0x07, 0xb5, 0x44,
	0x8a, 0x1f, 0xce, 0x87, 0x98, 0x66, 0x64, 0xc7, 0xc5, 0xef, 0x5b, 0x9a, 0x53, 0x92, 0x59, 0x90,
	0x53, 0x09, 0xd3, 0xaa, 0xcd, 0xc5, 0x01, 0x13, 0x22, 0xa8, 0x3f, 0x89, 0x0d, 0xcc, 0x37, 0x06,
	0x04, 0x00, 0x00, 0xff, 0xff, 0xdb, 0x9d, 0x9e, 0xae, 0xdf, 0x00, 0x00, 0x00,
}
...
func NewMultiplyServiceClient(cc *grpc.ClientConn) MultiplyServiceClient {
	return &multiplyServiceClient{cc}
}

func (c *multiplyServiceClient) Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (*UnimplementedMultiplyServiceServer) Multiply(ctx context.Context, req *Request) (*Response, error) {
